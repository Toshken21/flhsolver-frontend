        ...
        <div>
            ...
            <section className={HomeCSS["title-container"]}>
                ...
                <nav className={HomeCSS["nav"]}>
                    <ul className={HomeCSS["nav-ul"]}>
                        ...
                        <li>
                            <a href="/seventwo"  className={HomeCSS["nav-link"]}>SevenTwo</a>
                        </li>

                        <li>
                            <a href="#our-pricing" id="pricing-nav" className={HomeCSS["nav-link"]}>Pricing</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#beta-signup-section" id={HomeCSS["beta-signup-nav"]} className={HomeCSS["nav-link"]}>JOIN BETA</a>
                        </li>
                ...
                <a className={HomeCSS["title-join-beta"]} href="#beta-signup-section">JOIN BETA</a>
            </section>
            <section className={HomeCSS["overview"]} id="overview">
                ...
                <div className="overview-content-holder">
                    <img src={require("./homeImages/pair-of-aces.png")} alt="pair-of-aces" id={HomeCSS["pair-of-aces"]} />
...
{/*
            ...
            <section className={HomeCSS["affiliate-program"]} id="affiliate-program">
                ...
                <h2 className={HomeCSS["affiliate-program-h2"]}>Join our great affiliate program</h2>
    ...
    */}
            <section className={HomeCSS["beta-signup-section"]} id="beta-signup-section">
                ...
                <form className={HomeCSS["beta-signup-form"]} onSubmit={handleSubmit}>
